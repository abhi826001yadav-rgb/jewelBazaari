...
function getAuthErrorMessage(error) {
    ...
    const messages = {
        ...
        'auth/api-key-not-valid.-please-pass-a-valid-api-key.': 'Google sign-in is blocked. On your Browser API key → API restrictions → click the "40 APIs" dropdown → add Identity Toolkit API and Token Service API → Save. Wait 5 minutes, then hard refresh.',
