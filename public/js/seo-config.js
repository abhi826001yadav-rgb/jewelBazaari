...
export const PAGE_SEO = {
    'index.html': {
        ...
        robots: 'index, follow',
        type: 'website',
        breadcrumb: [{ name: 'Home', path: '/index.html' }]
    },
    'gold.html': {
        ...
        breadcrumb: [
            ...
            { name: 'Gold Jewellery', path: '/gold.html' }
        ],
        listingsHeading: 'Gold Jewellery Listings'
    },
    'diamond.html': {
        ...
        breadcrumb: [
            { name: 'Home', path: '/index.html' },
            { name: 'Diamond Jewellery', path: '/diamond.html' }
        ],
        listingsHeading: 'Diamond Jewellery Listings'
    },
    'gemstones.html': {
        ...
        breadcrumb: [
            { name: 'Home', path: '/index.html' },
            { name: 'Gemstone Jewellery', path: '/gemstones.html' }
        ],
        listingsHeading: 'Gemstone Jewellery Listings'
    },
    'earrings.html': {
        ...
        breadcrumb: [
            { name: 'Home', path: '/index.html' },
            { name: 'Earrings', path: '/earrings.html' }
        ],
        listingsHeading: 'Earrings Listings'
    },
    'rings.html': {
        ...
        breadcrumb: [
            { name: 'Home', path: '/index.html' },
            { name: 'Rings', path: '/rings.html' }
        ],
        listingsHeading: 'Rings Listings'
    },
    'all-jewellery.html': {
        ...
        breadcrumb: [
            { name: 'Home', path: '/index.html' },
            { name: 'All Jewellery', path: '/all-jewellery.html' }
        ],
        listingsHeading: 'All Jewellery Listings'
    },
    'wedding.html': {
        ...
        breadcrumb: [
            { name: 'Home', path: '/index.html' },
            { name: 'Wedding Jewellery', path: '/wedding.html' }
        ]
    },
    'combos.html': {
        ...
        breadcrumb: [
            { name: 'Home', path: '/index.html' },
            { name: 'Jewellery Combos', path: '/combos.html' }
        ]
    },
    'more.html': {
        ...
        breadcrumb: [
            { name: 'Home', path: '/index.html' },
            { name: 'More Collections', path: '/more.html' }
        ]
    },
    'query.html': {
        ...
        breadcrumb: [
            { name: 'Home', path: '/index.html' },
            { name: 'Contact Us', path: '/query.html' }
        ]
    },
    'admin.html': {
